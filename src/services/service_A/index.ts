...
const users: Array<UserData> = [
    {id:1,name:"gaming",email:"sabi@gmail.com",role:"admin"},
    {id:2,name:"asus rog",email:"asus@gmail.com",role:"user"},
    {id:3,name:"samsung",email:"samsung@gmail.com",role:"admin"},
    {id:4,name:"android ",email:"android@gmail.com",role:"user"},
]
